...
def execute_gemini_vision_analysis(lat, lng):
  ...
  return (
    <div className="flex-1 overflow-y-auto px-6 md:px-10 py-8 space-y-8 no-scrollbar text-left select-none pb-20">
      ...
      {/* CORE DISPLAY WINDOW */}
      <section className={`${panelStyle} rounded-2xl p-6 min-h-112.5 flex flex-col justify-between relative`}>
        ...
        {activeTab === 'flow' && (
          <div className="space-y-6">
            ...
            <div className="flex justify-center py-4 bg-[#0e0e0e] rounded-xl border border-white/5 p-6 select-none overflow-x-auto">
              <svg className="w-200 h-40 shrink-0 font-mono text-xs" textAnchor="middle" xmlns="http://www.w3.org/2000/svg">
                <defs>
                ...
                <text x="75" y="65" className="fill-white font-bold text-xs font-mono">1. ESP32 Node</text>
                ...
                <text x="270" y="65" className="fill-white font-bold text-xs font-mono">2. MQTT Broker</text>
                ...
                <text x="465" y="65" className="fill-white text-xs font-mono font-bold">3. Django Listener</text>
                ...
                <text x="660" y="65" className="fill-white text-xs font-mono font-bold">4. Django ASGI</text>
